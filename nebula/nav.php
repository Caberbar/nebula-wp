...
if ($url_actual == '/wp2023/') {
  $home = true;
} elseif ($url_actual != '/wp2023/') {
  $about = true;
  $home = false;
}
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></button><a class="navbar-brand logos logonavother" href="<?php echo home_url(); ?>"><img class="logonav" src="<?php echo bloginfo('template_directory') ?>/assets/images/logo/logoblancoletras.png"></img></a>
    </div>
    <div class="collapse navbar-collapse" id="custom-collapse">
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown <?php if ($home) {
                              echo 'enlace-actual';
                            } ?>"><a href="<?php echo home_url(); ?>"><span>Home</span></a> <!-- class="dropdown-toggle" todos los li a tenian esta clase añadiendo un simbolo con una flecha hacia abjo-->
        ...
        <!--  <ul class="dropdown-menu">-->
        <li class="dropdown <?php if ($about) {
                              echo 'enlace-actual';
        ...
        <li class="dropdown"><a href="<?php echo get_page_link(get_page_object("BLOG")->ID); ?>"><span>Blog</span></a> <!-- Antes era Services -->
          <!--<ul class="dropdown-menu">-->
        ...
        <!--<li class="dropdown"><a href="<?php //echo get_page_link(get_page_object("GALLERY")->ID); ?>"><span>Gallery</span></a>  Antes era Pricing  -->
        <!--<ul class="dropdown-menu">-->
        <!--  <li><a href="pricing1.html">Pricing 1</a></li>-->
        <!--  <li><a href="pricing2.html">Pricing 2</a></li>-->
        <!--</ul>-->
        <!--</li>-->
        <li class="dropdown"><a href="<?php echo get_permalink(get_page_object('EVENTS')->ID) ?>"><span>Events</span></a> <!-- Antes era Gallery  -->
          <!--<ul class="dropdown-menu">-->
        ...
        <li class="dropdown"><a href="<?php echo get_page_link(get_page_object("CONTACT")->ID); ?>"><span>Contact</span></a>
          <!--<ul class="dropdown-menu">-->
        ...
        <li class="dropdown"><a href="<?php echo get_page_link(get_page_object("ARCHIVES")->ID); ?>"><span>Archives</span></a>
          <!--<ul class="dropdown-menu">-->
        ...
        <li><a href="<?php echo get_page_link(get_page_object("PRIVATE")->ID); ?>"><span><i class="fa fa-user"></i></span></a></li>
