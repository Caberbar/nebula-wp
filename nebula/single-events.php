...
$cats = wp_get_post_categories($post_id, array('taxonomy'   => 'events-category')); // 'taxonomy'   => 'events-category'
          ...
          <div class="col-xs-12 col-md-6 col-md-offset-6 side-image-text">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="post-categories posts-blog posts-blog-cat"><i class="fa fa-thumb-tack">&nbsp;:</i><?php do_shortcode('[mpm_show_categories id="' . $post->ID . '"]'); ?></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8">
              <div class="post">
                <div class="post-entry">
                  ...
                  <div class="post-entry posts-excerpt-events">
                    <?php do_shortcode('[mpm_show_all_fields id="' . $post->ID . '"]'); ?>
                  </div>
                  <br>
                  <?php the_content(); ?>
                  <br>
                  <div class="post-categories posts-blog posts-tags posts-blog-cat"><i class="fa-solid fa-tags">&nbsp;:</i><?php do_shortcode('[mpm_show_tags id="' . $post->ID . '"]'); ?></div>
                </div>
              </div>
              <div class="comments">
                ...
                <div class="post mb-20 ">
                  ...
                  <div class="post-header font-alt">
                    ...
                    <div class="post-meta info-head-post author-post">By&nbsp;<?php the_author_posts_link() ?>&nbsp;| <?php the_time('F j, Y') ?></div>
                      <div class="post-meta">
                        <div class="post-categories"><i class="fa fa-thumb-tack">:</i><?php do_shortcode('[mpm_show_categories id="' . $post->ID . '"]'); ?></div>
                      </div>
                  </div>
                  <!--<div class="post-entry">-->
                  <!--  <p>the_excerpt();?></p>-->
              ...
              <div class="comments sepa-envents">
