...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      ?>
      <div class="main reset-margin-custom">
        <section class="module bg-dark-30" data-background="<?php echo bloginfo('template_directory') ?>/assets/images/login/login2.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">LICENSE</h1>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="module bg-colore">
          ...
          <p>Who we are</p>
        <br>
        <p>Suggested text: Our website address is: https://cberbar117.ieszaidinvergeles.es/wp2023.</p>
        <br>
        <p>Comments</p>
        <br>
